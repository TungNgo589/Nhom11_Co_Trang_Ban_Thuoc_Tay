...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=LAPTOP-JULVIGMI;Initial Catalog=QLThuocDAPM4;Integrated Security=True;Encrypt=True;Trust Server Certificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Benh>(entity =>
        {
            entity.HasKey(e => e.MaBenh).HasName("PK__Benh__E84E00CF3726AB14");
        ...
        {
            entity.HasKey(e => e.MaBinhLuan).HasName("PK__BinhLuan__87CB66A0EFEEBF2C");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__ChiTietD__3213E83FA2538513");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__ChiTietG__3213E83F85AEABD1");
        ...
        {
            entity.HasKey(e => e.MaDanhGia).HasName("PK__DanhGia__AA9515BFE1851245");
        ...
        {
            entity.HasKey(e => e.MaDm).HasName("PK__DanhMuc__7A3EF4083DC78D3B");
        ...
        {
            entity.HasKey(e => e.MaDh).HasName("PK__DonHang__7A3EF40F6CAF2F43");
        ...
        {
            entity.HasKey(e => e.MaGiamGia).HasName("PK__GiamGia__EF9458E47340D80C");
        ...
        {
            entity.HasKey(e => e.MaGh).HasName("PK__GioHang__7A3E2D6B664BC5DD");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__HinhAnh__3213E83FEF2ADF16");
        ...
        {
            entity.HasKey(e => e.MaKhuyenMai).HasName("PK__KhuyenMa__6F56B3BD1CFEA888");
        ...
        {
            entity.HasKey(e => e.MaNguoiDung).HasName("PK__NguoiDun__446439EA119C89DC");
        ...
        {
            entity.HasKey(e => e.MaNhaCungCap).HasName("PK__NhaCungC__53DA92054F39B4FA");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__PhanQuye__CD98460A158A8870");
        ...
        {
            entity.HasKey(e => e.MaSp).HasName("PK__SanPham__7A227A7AF373B468");
        ...
        {
            entity.HasKey(e => e.MaThanhToan).HasName("PK__ThanhToa__D4B258447D67F13C");
