...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=LAPTOP-JULVIGMI;Initial Catalog=QLThuocDAPM4;Integrated Security=True;Trust Server Certificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Benh>(entity =>
        {
            entity.HasKey(e => e.MaBenh).HasName("PK__Benh__E84E00CFDD261F3F");
        ...
        {
            entity.HasKey(e => e.MaBinhLuan).HasName("PK__BinhLuan__87CB66A0A01690FD");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__ChiTietD__3213E83FB72B0890");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__ChiTietG__3213E83F4F35B28E");
        ...
        {
            entity.HasKey(e => e.MaDanhGia).HasName("PK__DanhGia__AA9515BFF83CDD84");
        ...
        {
            entity.HasKey(e => e.MaDm).HasName("PK__DanhMuc__7A3EF408B5581276");
        ...
        {
            entity.HasKey(e => e.MaDh).HasName("PK__DonHang__7A3EF40FDA339BF8");
        ...
        {
            entity.HasKey(e => e.MaGiamGia).HasName("PK__GiamGia__EF9458E4099E21D0");
        ...
        {
            entity.HasKey(e => e.MaGh).HasName("PK__GioHang__7A3E2D6BE4F9A56B");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__HinhAnh__3213E83F4700C6EC");
        ...
        {
            entity.HasKey(e => e.MaKhuyenMai).HasName("PK__KhuyenMa__6F56B3BD93F8E7D6");
        ...
        {
            entity.HasKey(e => e.MaNguoiDung).HasName("PK__NguoiDun__446439EA427A97E4");
        ...
        {
            entity.HasKey(e => e.MaNhaCungCap).HasName("PK__NhaCungC__53DA9205A4AEEA49");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__PhanQuye__CD98460AB34B116F");
        ...
        {
            entity.HasKey(e => e.MaSp).HasName("PK__SanPham__7A227A7A6A9AE7E9");
        ...
        {
            entity.HasKey(e => e.MaThanhToan).HasName("PK__ThanhToa__D4B25844F70B5581");
