...
public partial class QlthuocDapm2Context : DbContext
{
    public QlthuocDapm2Context()
    {
    }

    public QlthuocDapm2Context(DbContextOptions<QlthuocDapm2Context> options)
        : base(options)
    {
    }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-Q5EI430;Initial Catalog=QLThuocDAPM2;Integrated Security=True;Trust Server Certificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Benh>(entity =>
        {
            entity.HasKey(e => e.MaBenh).HasName("PK__Benh__E84E00CF8E52D626");
        ...
        {
            entity.HasKey(e => e.MaBinhLuan).HasName("PK__BinhLuan__87CB66A064C5E34B");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__ChiTietD__3213E83FBE10C70F");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__ChiTietG__3213E83F93624C18");
        ...
        {
            entity.HasKey(e => e.MaDanhGia).HasName("PK__DanhGia__AA9515BF1A9315E1");
        ...
        {
            entity.HasKey(e => e.MaDm).HasName("PK__DanhMuc__7A3EF408B688CFC5");
        ...
        {
            entity.HasKey(e => e.MaDh).HasName("PK__DonHang__7A3EF40F136E64C7");
        ...
        {
            entity.HasKey(e => e.MaGiamGia).HasName("PK__GiamGia__EF9458E40C6A9C2A");
        });

        modelBuilder.Entity<GioHang>(entity =>
        {
            entity.HasKey(e => e.MaGh).HasName("PK__GioHang__7A3E2D6B3D0FEF71");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__HinhAnh__3213E83FDA00EBDE");
        ...
        {
            entity.HasKey(e => e.MaKhuyenMai).HasName("PK__KhuyenMa__6F56B3BD169468D7");
        ...
        {
            entity.HasKey(e => e.MaNguoiDung).HasName("PK__NguoiDun__446439EA721A636C");
        ...
        {
            entity.HasKey(e => e.MaNhaCungCap).HasName("PK__NhaCungC__53DA92058FEA8B73");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__PhanQuye__CD98460A588639D7");
        ...
        {
            entity.HasKey(e => e.MaSp).HasName("PK__SanPham__7A227A7A74716E09");
        ...
        {
            entity.HasKey(e => e.MaThanhToan).HasName("PK__ThanhToa__D4B25844E76A4EDC");
